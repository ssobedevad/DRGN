...
{
	public class GlacialYoyo : ModProjectile
	{
		...
		public override void PostAI()
		{
			...
			if (projectile.localAI[0] >= 50 && VelocityToTarget() != Vector2.Zero)
			{ 
				int projid  = Projectile.NewProjectile(projectile.Center, VelocityToTarget(), ModContent.ProjectileType<IceShatter>(), projectile.damage, projectile.knockBack, projectile.owner);
				projectile.localAI[0] = 0;
				Main.projectile[projid].timeLeft = 50;
			}
