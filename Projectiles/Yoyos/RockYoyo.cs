...
{
	public class RockYoyo : ModProjectile
	{
		...
		public override void PostAI()
		{
			...
			if (projectile.localAI[0] >= 45 && VelocityToTarget() != Vector2.Zero)
			{
				int projid = Projectile.NewProjectile(projectile.Center, VelocityToTarget(), ModContent.ProjectileType<RockShot>(), projectile.damage, projectile.knockBack, projectile.owner);
				projectile.localAI[0] = 0;
				Main.projectile[projid].timeLeft = 45;
			}
