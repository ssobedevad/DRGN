...
{
	public class AntYoyo : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			...
			ProjectileID.Sets.YoyosMaximumRange[projectile.type] = 185f;
		...
		public override void PostAI()
		{
			...
			if (projectile.localAI[0] >= 55 && VelocityToTarget() != Vector2.Zero)
			{
				int projid = Projectile.NewProjectile(projectile.Center, VelocityToTarget(), ModContent.ProjectileType<AntBiterJaws>(), projectile.damage, projectile.knockBack, projectile.owner);
				projectile.localAI[0] = 0;
				Main.projectile[projid].timeLeft = 55;
			}
