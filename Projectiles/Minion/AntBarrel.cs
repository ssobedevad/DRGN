...
{
    public class AntBarrel : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            if ((Main.player[projectile.owner].ownedProjectileCounts[mod.ProjectileType("AntMinion")] + Main.player[projectile.owner].ownedProjectileCounts[mod.ProjectileType("AntMinionFlying")]) < projectile.ai[1])
            {
                ...
                {
                    if(Main.npc[Target()].noTileCollide ||(Main.npc[Target()].Center.Y - projectile.Center.Y)  <  100)
                    ...
                    else { Projectile.NewProjectile(projectile.Center, Vector2.Zero, mod.ProjectileType("AntMinion"), projectile.damage, projectile.knockBack, projectile.owner, projectile.whoAmI); }
