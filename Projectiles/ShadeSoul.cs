...
namespace DRGN.Projectiles
{
    public class ShadeSoul : ModProjectile
    {
        ...
        public override void Kill(int timeleft)
        {
            for (int i = 0; i < 4; i++)
            {
                int proj = Projectile.NewProjectile(projectile.Center, Vector2.Normalize(Main.MouseWorld - projectile.Center) * 10, mod.ProjectileType("ShadeBlast"), (int)(projectile.damage * 0.8f), projectile.knockBack * 0.8f, projectile.owner);
