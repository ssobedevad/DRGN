...
{
    public class GalacticMissile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float shootSpeed = DRGNModWorld.MentalMode ? 26f : Main.expertMode ? 20f : 14f;
            if (!passedTarget)
            {
                Move(shootSpeed);
            }
        ...
        {
            target.AddBuff(mod.BuffType("GalacticCurse"), 20);
        }
