...
namespace DRGN.UI
{
    ...
    class EngineerGun : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            panel = new UIPanel(); // 2
            panel.Left.Pixels = 600;
            panel.Top.Set(96, 0);
            panel.Width.Set(108, 0);
            panel.Height.Set(162, 0);
            
            slot1 = new UIPanel(); // 2

            slot1.Left.Set(0, 0);
            slot1.Top.Set(0, 0);
            slot1.Width.Set(52, 0);
            slot1.Height.Set(52, 0);
            ...
            slot2.Left.Set(56, 0);
            slot2.Top.Set(0, 0);
            slot2.Width.Set(52, 0);
            slot2.Height.Set(52, 0);
            ...
            slot3.Left.Set(0, 0);
            slot3.Top.Set(54, 0);
            slot3.Width.Set(52, 0);
            slot3.Height.Set(52, 0);
            ...
            slot4.Left.Set(56, 0);
            slot4.Top.Set(54, 0);
            slot4.Width.Set(52, 0);
            slot4.Height.Set(52, 0);
            ...
            slot5.Left.Set(0, 0);
            slot5.Top.Set(108, 0);
            slot5.Width.Set(52, 0);
            slot5.Height.Set(52, 0);
            ...
            slot6.Left.Set(56, 0);
            slot6.Top.Set(108, 0);
            slot6.Width.Set(52, 0);
            slot6.Height.Set(52, 0);
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(accSlot, new Vector2(panel.Left.Pixels + slot1.Left.Pixels, panel.Top.Pixels+slot1.Top.Pixels), new Rectangle(0, 0, 52, 52), Color.White);
            if (itemSlot1 != null)
            {
            ...
            spriteBatch.Draw(accSlot, new Vector2(panel.Left.Pixels + slot2.Left.Pixels, panel.Top.Pixels + slot2.Top.Pixels), new Rectangle(0, 0, 52, 52), Color.White);
            if (itemSlot2 != null)
            {
            ...
            spriteBatch.Draw(accSlot, new Vector2(panel.Left.Pixels + slot3.Left.Pixels, panel.Top.Pixels + slot3.Top.Pixels), new Rectangle(0, 0, 52, 52), Color.White);
            if (itemSlot3 != null)
            {
            ...
            spriteBatch.Draw(accSlot, new Vector2(panel.Left.Pixels + slot4.Left.Pixels, panel.Top.Pixels + slot4.Top.Pixels), new Rectangle(0, 0, 52, 52), Color.White);
            if (itemSlot4 != null)
            {
            ...
            spriteBatch.Draw(accSlot, new Vector2(panel.Left.Pixels + slot5.Left.Pixels, panel.Top.Pixels + slot5.Top.Pixels), new Rectangle(0, 0, 52, 52), Color.White);
            if (itemSlot5 != null)
            {
            ...
            spriteBatch.Draw(accSlot, new Vector2(panel.Left.Pixels + slot6.Left.Pixels, panel.Top.Pixels + slot6.Top.Pixels), new Rectangle(0, 0, 52, 52), Color.White);
            if (itemSlot6 != null)
            {
