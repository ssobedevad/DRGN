...
namespace DRGN.NPCs.Boss
{
    ...
    public class IceFish : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (!Main.expertMode)
            {
                if (Main.rand.Next(0, 20 + (int)(npc.life / 1000)) == 1 || Main.rand.Next(0, 1 + (int)(npc.lifeMax / npc.life) * 40) == 2) { Projectile.NewProjectile(npc.Center.X, npc.Center.Y, npc.velocity.X, npc.velocity.Y + 10f, mod.ProjectileType("IceCluster"), npc.damage / 2, 0); }
            }
