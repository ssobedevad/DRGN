...
namespace DRGN.NPCs.Boss
{
    ...
    public class FireDragon : ModNPC
    {
        ...
        {
            npc.aiStyle = -1;
            npc.lifeMax = DRGNModWorld.MentalMode ? 1070100 : Main.expertMode ? 522000 : 580000;
        ...
        public override void AI()
        {
            ...
            if (npc.ai[0] == 4)
            {
                ...
                if (npc.ai[1] >= 600 && !NPC.AnyNPCs(mod.NPCType("MegaMagmaticCrawlerHead")))
                {
                    npc.ai[0] = 5;
                    if (Main.netMode != 1)
                    {
