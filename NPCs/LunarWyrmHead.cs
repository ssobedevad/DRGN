...
namespace DRGN.NPCs
{
    public class LunarWyrmHead : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            npc.lifeMax = 75000;        //this is the npc health
            npc.damage = 250;    //this is the npc damage
        ...
        public override bool PreAI()
        {
            ...
            if (Main.netMode != 1)
            {
                ...
                if (npc.ai[0] == 0)
                {
                    ...
                    for (int i = 0; i < randomWormLength; ++i)
                    {
                        ...
                        latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("LunarWyrmBody"), npc.whoAmI, 0, latestNPC);
                        Main.npc[(int)latestNPC].realLife = npc.whoAmI;
                        Main.npc[(int)latestNPC].ai[3] = npc.whoAmI;
                    }
                    // When we're out of that loop, we want to 'close' the worm with a tail part!
                    latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("LunarWyrmTail"), npc.whoAmI, 0, latestNPC);
                    Main.npc[(int)latestNPC].realLife = npc.whoAmI;
                    Main.npc[(int)latestNPC].ai[3] = npc.whoAmI;
            ...
            if (NPC.AnyNPCs(mod.NPCType("LunarWyrmBody")) == false) { npc.active = false; }
