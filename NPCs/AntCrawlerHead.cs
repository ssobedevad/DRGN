...
namespace DRGN.NPCs
{
    public class AntCrawlerHead : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            npc.lifeMax = 65000;        //this is the npc health
        ...
        public override bool PreAI()
        {
            ...
            if (Main.netMode != 1)
            {
                ...
                if (npc.ai[0] == 0)
                {
                    ...
                    for (int i = 0; i < randomWormLength; ++i)
                    {
                        ...
                        latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("AntCrawlerBody"), npc.whoAmI, 0, latestNPC);
                        Main.npc[(int)latestNPC].realLife = npc.whoAmI;
                        Main.npc[(int)latestNPC].ai[3] = npc.whoAmI;
                    }
                    // When we're out of that loop, we want to 'close' the worm with a tail part!
                    latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("AntCrawlerTail"), npc.whoAmI, 0, latestNPC);
                    Main.npc[(int)latestNPC].realLife = npc.whoAmI;
                    Main.npc[(int)latestNPC].ai[3] = npc.whoAmI;
            ...
            if (NPC.AnyNPCs(mod.NPCType("AntCrawlerBody")) == false) { npc.active = false; }
        ...
        public override void NPCLoot()
        {
            ...
            {
                Item.NewItem(npc.getRect(), mod.ItemType("AntCrawlerScale"), 1);
            }
