...
{
    public class GunChamber4 : EngineerAttachments
    {
        
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Planten Mechanism");
            Tooltip.SetDefault("Increases damage and fire rate extremely greatly");
