...
{
    public class GunBody7 : EngineerAttachments
    {
        
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Flarium Body");
            Tooltip.SetDefault("Attacks produce flares and decreases spread slightly and increases damage very extremely greatly");
