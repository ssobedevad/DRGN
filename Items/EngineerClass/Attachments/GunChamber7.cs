...
{
    public class GunChamber7 : EngineerAttachments
    {
        
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Flarium Mechanism");
            Tooltip.SetDefault("Increases damage and fire rate by A LOT LOT LOT");
